                    ...
                    {filteredGroups.map((group, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {group.description && (
                            <p className="text-neutral-400 text-sm mb-4 line-clamp-2">{group.description}</p>
                          )}
                          ...
                          {group.is_member ? (
                            <div className="flex gap-2">
                              <button
                                ...
                                className="flex-1 bg-neutral-700 text-white py-2 rounded-lg font-bold hover:bg-neutral-600 transition-colors"
                              >
                                View
                              </button>
                              <motion.button
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {myGroups.map((group, idx) => (
                      ...
                      >
                        ...
                        <p className="text-neutral-500 text-sm mb-4">{group.member_count || 0} members</p>
                        <div className="flex gap-2">
                          <button
                            onClick={() => navigate(`/study-groups/${group.id}`)}
                          ...
                          <motion.button
                            ...
                            className="px-4 py-2 text-red-400 hover:bg-red-500/10 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                          >
                            {actionLoadingId === group.id ? "..." : <LogOut size={18} />}
                          </motion.button>
                        </div>
                      </motion.div>
                    ))}
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-3xl font-bold text-blue-400">#{leaderboard.user_rank.rank}</p>
                      </div>
                      ...
                      <tbody>
                        {leaderboard.entries.slice(0, 50).map((entry, idx) => (
                          ...
                          >
                            ...
                            <td className="py-4 px-6 font-medium truncate max-w-[180px]">{entry.user_email}</td>
                            <td className="py-4 px-6 text-right font-bold text-blue-400">{entry.total_xp} XP</td>
                            <td className="py-4 px-6 text-right text-neutral-400">
                              {typeof entry.study_hours === "number" ? entry.study_hours.toFixed(1) : "0.0"}h
                            </td>
